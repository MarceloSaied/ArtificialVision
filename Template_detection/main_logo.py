...
threshold_min = round(threshold_mid-0.01,2)
threshold_max = round(threshold_mid+0.01,2)
...
while threshold >= threshold_min:
    ...
    for m  in range(0, mappers):
        ...
        comm = 'python ' + "ID_test.py" + " " + templateImage + " " + img_orig + " " + str(rotacionStart) + " " + str(rotacionEnd) + " " +str(threshold) +" "+str(orden)
        print(comm )
